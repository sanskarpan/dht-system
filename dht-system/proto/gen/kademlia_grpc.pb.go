...
const (
	KademliaService_Ping_FullMethodName      = "/dht.KademliaService/Ping"
	KademliaService_Store_FullMethodName     = "/dht.KademliaService/Store"
	KademliaService_FindNode_FullMethodName  = "/dht.KademliaService/FindNode"
	KademliaService_FindValue_FullMethodName = "/dht.KademliaService/FindValue"
)
...
type KademliaServiceClient interface {
	Ping(ctx context.Context, in *KPingRequest, opts ...grpc.CallOption) (*KPingResponse, error)
	Store(ctx context.Context, in *KStoreRequest, opts ...grpc.CallOption) (*KStoreResponse, error)
...
func (c *kademliaServiceClient) Ping(ctx context.Context, in *KPingRequest, opts ...grpc.CallOption) (*KPingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(KPingResponse)
...
func (c *kademliaServiceClient) Store(ctx context.Context, in *KStoreRequest, opts ...grpc.CallOption) (*KStoreResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(KStoreResponse)
...
type KademliaServiceServer interface {
	Ping(context.Context, *KPingRequest) (*KPingResponse, error)
	Store(context.Context, *KStoreRequest) (*KStoreResponse, error)
...
func (UnimplementedKademliaServiceServer) Ping(context.Context, *KPingRequest) (*KPingResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Ping not implemented")
}
func (UnimplementedKademliaServiceServer) Store(context.Context, *KStoreRequest) (*KStoreResponse, error) {
...
func RegisterKademliaServiceServer(s grpc.ServiceRegistrar, srv KademliaServiceServer) {
	// If the following call panics, it indicates UnimplementedKademliaServiceServer was
...
func _KademliaService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KademliaServiceServer).Ping(ctx, req.(*KPingRequest))
	}
...
func _KademliaService_Store_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KademliaServiceServer).Store(ctx, req.(*KStoreRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var KademliaService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dht.KademliaService",
